...
if (isset($_GET['animal_id'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM rapport_veterinaire WHERE animal_id = :animal_id ORDER BY date DESC");
...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php if (!empty($comptes_rendus)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <tr><td colspan="2">Aucun compte rendu disponible pour cet animal.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
    ...
    <form action="ajouter_compte_rendu.php" method="POST">
        ...
        <textarea name="etat" id="etat" required></textarea><br><br>
